      ...
      <div className="container">
        <div className="row border border-warning m-3"
          ...
          <div className="col p-2">
            ...
            >
              <center>
                <Card entry={productData} index={0} local={true} />
              </center>
              <br />
            </div>
            <div className="row">
          ...
          <div className="col">
            ...
            >
              <form>
                ...
                <div>
                  {selectUserImg.length
                    ? <p className='text-muted' style={{ marginBottom: "-0.1rem" }}>
                      Select the below image to fit in left card.
                    </p>
                    : null}
