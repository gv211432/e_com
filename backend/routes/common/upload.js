...
router.post("/common/upload", uploadController.uploadFiles);
router.post("/common/:id/uploadProfilePic", uploadController.uploadUserImg);
router.get("/common/files", uploadController.getListFiles);
router.get("/common/files/:name", uploadController.download);
